...
To replicate the analysis in the main paper \textit{Bayesian Inference for Cox Proportional Hazard Models with Partial Likelihoods,Nonlinear Covariate Effects and Correlated Observations}, we can do the following:
...
The posterior of the frailty log precision $\theta_\xi$ can be obtained as:
...
This can be converted to the posterior of the SD parameter $\sigma_\xi$ as:
